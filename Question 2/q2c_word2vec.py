...
def naive_softmax_loss_and_gradient(
    ...
    logits = np.dot(outside_vectors, center_word_vec)  # shape (V,)
...
def skipgram(current_center_word, outside_words, word2ind,
    ...
    for outside_word in outside_words:
        ...
        loss += loss_temp
        grad_center_vecs[central_word_ind] = grad_center_vecs[central_word_ind] + grad_center_vecs_temp
        grad_outside_vectors = grad_outside_vectors + grad_outside_vectors_temp
